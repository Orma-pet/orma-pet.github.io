...
export const FEATURES = {
  it: {
    ...
    lead: "Abbiamo tagliato tutto ciò che non serviva. Quello che resta sono sei strumenti, ognuno pensato per un momento preciso della ricerca — e ognuno con la privacy come impostazione predefinita, non come ripensamento.",
  ...
  en: {
    ...
    lead: 'We cut everything that did not belong. What remains is six tools, each made for a precise moment in the search — and each with privacy as the default, not an afterthought.',
